...
const EditSellerBannerDrawer = ({ open, onClose }: Props) => {
  ...
  const initialValues = bannerSchema.reduce((accumulator, currentValue) => {
...
export default EditSellerBannerDrawer;
