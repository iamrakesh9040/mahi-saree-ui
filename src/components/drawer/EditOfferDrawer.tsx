...
const EditOfferDrawer = ({ open, onClose }: Props) => {
  ...
  const offerSchema = [
    ...
    },
    {
      ...
      required: true,
      type: "number",
      validationSchema: Yup.number().required("Discount(%) is required"),
      initialValue: "",
      className: "col-span-12",
    },
    {
      ...
      required: true,
      type: "number",
      validationSchema: Yup.number().required("Max Discount is required"),
      initialValue: "",
      className: "col-span-12",
    },
  ];
...
export default EditOfferDrawer;
