...
const EditSubCategoriesDrawer = ({ open, onClose }: Props) => {
  ...
  const initialValues = subCategorySchema.reduce(
...
export default EditSubCategoriesDrawer;
