...
const ReturnOrderForm = ({
  ...
  const Schema = [
    ...
    },
    {
      ...
      type: "text",
      initialValue: "",
      className: item?.paymentMode === "COD" ? "col-span-12" : "hidden",
  ...
  const handleOperation = async (
    ...
    try {
      ...
      formData.append("type", "RETURNED");
      item?.paymentMode === "COD" &&
        formData.append("accountNumber", values?.accountNumber);
      item?.paymentMode === "COD" &&
        formData.append("accountName", values?.accountName);
      item?.paymentMode === "COD" &&
        formData.append("ifscCode", values?.ifsCode);
      item?.paymentMode === "COD" &&
    ...
    >
      <div className="md:w-[35rem] w-full h-full bg-white gap-2   rounded-lg flex flex-col p-4">
        <div className="flex justify-between gap-2">
          <p className=" text-xl font-medium text-gray-800">Return Order</p>
