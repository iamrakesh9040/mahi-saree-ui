...
const ProfileUpdateForm: React.FC<ProfileUpdateFormProps> = ({
  ...
  //       photo:
  //         "https://www.freeimages.com/vector/autumn-leaves-frame-with-grungy-splats-5188428",
  //     },
  //     isAlert: true,
  //   });
  //   // console.log("profile updated data", res);
  //   if (res?.status === 200) {
              ...
              <div className="w-full flex flex-col">
                ...
                <div className="flex items-center gap-3">
                  <Field
                    as="select"
                    name="countryCode"
                    className="w-[30%] border rounded p-2 outline-none"
                  >
                  ...
                  <Field
                    type="number"
                    name="phone"
                    className="w-[70%] border rounded p-2 outline-none"
