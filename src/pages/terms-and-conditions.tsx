...
const TermsAndConditions = () => {
  return (
    <PublicLayout title="Privacy Policy | Shree Odisha Handloom">
      <div className="main-container py-10 font-medium prose prose-sm flex flex-col gap-5 p-10">
        <h2>
          <strong>Terms and Conditions</strong>
        </h2>

        <p>Welcome to Shree Odisha Handloom!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of Shree Odisha Handloom Website, located at
          https://shreyanecom-recent.vercel.app/.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Shree Odisha Handloom if you do not
        ...
        <p>
          ...
          compliant to the Company terms and conditions. The Company, Ourselves,
        ...
        <p>
          We employ the use of cookies. By accessing Shree Odisha Handloom, you
          agreed to use cookies in agreement with the Shree Odisha Handlooms
          Privacy Policy.
        </p>
        ...
        <p>
          Unless otherwise stated, Shree Odisha Handloom and/or its licensors
          own the intellectual property rights for all material on Shree Odisha
          Handloom. All intellectual property rights are reserved. You may
          access this from Shree Odisha Handloom for your own personal use
          subjected to restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Shree Odisha Handloom</li>
          <li>Sell, rent or sub-license material from Shree Odisha Handloom</li>
          <li>
            Reproduce, duplicate or copy material from Shree Odisha Handloom
          </li>
          <li>Redistribute content from Shree Odisha Handloom</li>
        </ul>
        ...
        <p>
          ...
          Shree Odisha Handloom does not filter, edit, publish or review
          Comments prior to their presence on the website. Comments do not
          reflect the views and opinions of Shree Odisha Handloom, its agents,
          ...
          applicable laws, Shree Odisha Handloom shall not be liable for the
        ...
        <p>
          Shree Odisha Handloom reserves the right to monitor all Comments and
        ...
        <p>
          You hereby grant Shree Odisha Handloom a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Shree Odisha Handloom; and
        ...
        <p>
          ...
          sending an e-mail to Shree Odisha Handloom. Please include your name,
        ...
        <p>
          No use of Shree Odisha Handlooms logo or other artwork will be allowed
